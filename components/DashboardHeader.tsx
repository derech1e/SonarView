    ...
    return (
        <div className={"mx-auto flex max-w-7xl items-center justify-between gap-x-6 p-6 lg:px-8"}>
            <div className={"flex items-center gap-x-4 overflow-header min-w-1/4"}>
                ...
                <span className="text-gray-400 dark:text-gray-500 text-5xl font-thin ">/</span>
                {
            ...
            <div className="flex items-center gap-6">
                <Link href="/dashboard">
                    <div
                        className="flex items-center group gap-2 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-black dark:hover:text-white rounded-md px-3 py-1.5">
